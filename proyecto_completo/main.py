...
def main():
    ...
    entrenar_gan_cnn_conjunto(generador_datos_gan, input_dim_gan, num_epochs=2)  # Ajusta según tus necesidades
    #entrenar_gan_cnn_conjunto(generador_datos_gan, input_dim=(2, 2), num_epochs=2)
